...
class EstoquePage(QWidget):
    ...
    def _setup_ui(self):
        ...
        btn_inserir.setFixedSize(130, 28)
        ...
        btn_recarregar.setFixedSize(28, 28)
        ...
        btn_exportar.setFixedSize(130, 28)
        ...
        self.campo_filtro.setFixedWidth(300)
        ...
        def criar_linha(rotulo, chave, simbolo="", cor="#5f6cf5", largura_label=105, word_wrap=False):
            ...
            lbl_nome.setMinimumWidth(largura_label)
